...
class PokemonPartsMixinClass with PokemonPartsMixin {
  factory PokemonPartsMixinClass.fromJson(Map<String, dynamic> json) =>
      _$PokemonPartsMixinClassFromJson(json);
  Map<String, dynamic> toJson() => _$PokemonPartsMixinClassToJson(this);
  PokemonPartsMixinClass();
}
...
class FragmentQuery$Query$Pokemon with EquatableMixin, PokemonPartsMixin {
  ...
  List<PokemonPartsMixinClass> evolutions;
...
class FragmentQuery$Query with EquatableMixin {
  ...
  PokemonPartsMixinClass charmander;
